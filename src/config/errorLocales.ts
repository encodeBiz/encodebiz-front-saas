...
export const errorDict: any = {
  es: {
    ...
    "task/evidence_required": "Debes subir al menos una evidencia antes de completar esta tarea",
  ...
  en: {
    ...
    "task/evidence_required": "You must upload at least one evidence file before completing this task",
