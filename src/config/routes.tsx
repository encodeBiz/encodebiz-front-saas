...
const CHECKINBIZ: any = [{
    ...
    name: 'Documents',
    link: `/${CHECKINBIZ_MODULE_ROUTE}/documents`,
    subMenu: []
}]
...
export const PUBLIC_PATH = ['/tools/scanner', '/legal/privacy-policy', '/legal/terms-and-conditions', '/tools/checking', '/tools/checking/maintenance']
