      ...
      <HelpTabs tabs={[
        {
          ...
          tabContent: <Box sx={{ width: "100%", p: 2, display: 'flex', flexDirection: 'column', gap: 2,pb:4 }}>
            ...
            {payloadPassIssuedFilter ? <>
              ...
              {payloadPassIssuedFilter?.type === 'event' && <BorderBox sx={{ width: "100%", p: 2, boxShadow: '0px 1px 4px 0.5px rgba(219, 217, 222, 0.85)', }}>
...

        {
          ...
          tabContent: <Box sx={{ width: "100%", p: 2, display: 'flex', flexDirection: 'column', gap: 2 ,pb:4}}>
            ...
            {payloadPassValidatorFilter ? <>
              ...
              {payloadPassValidatorFilter?.type === 'event' && <BorderBox sx={{ width: "100%", p: 2, boxShadow: '0px 1px 4px 0.5px rgba(219, 217, 222, 0.85)', }}>
